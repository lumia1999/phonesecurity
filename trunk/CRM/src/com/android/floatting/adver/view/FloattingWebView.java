...
public class FloattingWebView extends Activity implements DownloadListener, BDEngineListener {
	...
	private void getTagetUrl() {
		...
		try {
			...
			mBDEngine = new BDEngine(mPageUrl, mSearchTarget, mSearchRules, this, this);
			mBDEngine.start();
	...
	private class MyWebViewClient extends WebViewClient {
		...
		public void onReceivedError(WebView view, int errorCode,
			...
			//MobclickAgent.onEvent(FloattingWebView.this, "berror",titleString);//ͳ����ҳ���������
			Statistik stat = new Statistik(FloattingWebView.this,"ERROR","WEBVIEW","Code:"+errorCode);
			stat.start();
		}
	...
	public void onFinish(final String url) {
		...
		//Statistik stat = new Statistik(FloattingWebView.this,"BDENGINE","SEAONFINISH",null);
		//stat.start();
	...
	public void onError(BDECode aErrorCode) {
		...
		Statistik stat = new Statistik(FloattingWebView.this,"ERROR","BDENGINE","Search onError : " + aErrorCode);
		stat.start();
		runOnUiThread(new Runnable() {
            @Override
            public void run() {
