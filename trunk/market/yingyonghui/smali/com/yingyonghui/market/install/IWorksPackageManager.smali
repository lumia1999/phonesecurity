...
.method private a(Landroid/content/Context;Ljava/io/File;)Ljava/io/File;
    ...
    :cond_1
    :goto_0
    invoke-static {p2, v0}, Landroid/os/FileUtils;->copyFile(Ljava/io/File;Ljava/io/File;)Z
    ...
    .line 102
    iget-object v0, p0, Lcom/yingyonghui/market/install/IWorksPackageManager;->a:Ljava/lang/String;

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "Failed to make copy of file: "
...
.method public final a(Ljava/io/File;Ljava/lang/String;Landroid/os/Handler;)Z
    ...
    .line 57
    iget-object v2, p0, Lcom/yingyonghui/market/install/IWorksPackageManager;->a:Ljava/lang/String;
    ...
    .line 60
    :cond_0
    new-instance v2, Lcom/yingyonghui/market/install/IWorksPackageManager$PackageInstallObserver;

    invoke-direct {v2, p0, p3}, Lcom/yingyonghui/market/install/IWorksPackageManager$PackageInstallObserver;-><init>(Lcom/yingyonghui/market/install/IWorksPackageManager;Landroid/os/Handler;)V

    .line 64
    :try_start_1
    iget-object v3, p0, Lcom/yingyonghui/market/install/IWorksPackageManager;->c:Landroid/content/Context;

    invoke-direct {p0, v3, p1}, Lcom/yingyonghui/market/install/IWorksPackageManager;->a(Landroid/content/Context;Ljava/io/File;)Ljava/io/File;
    ...
    .line 69
    invoke-virtual {v2, p2, v9}, Lcom/yingyonghui/market/install/IWorksPackageManager$PackageInstallObserver;->packageInstalled(Ljava/lang/String;I)V
...
.method public final a(Ljava/lang/String;Landroid/os/Handler;)Z
    ...
    .line 151
    new-instance v0, Lcom/yingyonghui/market/install/IWorksPackageManager$PackageDeleteObserver;

    invoke-direct {v0, p0, p2}, Lcom/yingyonghui/market/install/IWorksPackageManager$PackageDeleteObserver;-><init>(Lcom/yingyonghui/market/install/IWorksPackageManager;Landroid/os/Handler;)V

    .line 152
    iget-object v1, p0, Lcom/yingyonghui/market/install/IWorksPackageManager;->c:Landroid/content/Context;
    ...
    .line 158
    invoke-virtual {v0, v7}, Lcom/yingyonghui/market/install/IWorksPackageManager$PackageDeleteObserver;->packageDeleted(Z)V
