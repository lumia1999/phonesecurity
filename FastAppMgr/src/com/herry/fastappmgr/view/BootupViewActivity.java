...
public class BootupViewActivity extends Activity {
	...
	private void initData(){
		Cursor c = PackageAddedDbAdapter.getInstance(this).getAllBootupHistory();
	...
	private class BootupAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(convertView == null){
				convertView = mLayoutInflater.inflate(R.layout.bootup_history_item, null);
				viewHolder = new ViewHolder();
				viewHolder.uptime = (TextView)convertView.findViewById(R.id.uptime);
				viewHolder.takeplaceTime = (TextView)convertView.findViewById(R.id.takeplace_time);
			...
			viewHolder.uptime .setText(getString(R.string.uptime_tip) +
					Utils.formatDuration(mCtx,c.getInt(c.getColumnIndex(BoottimeHistoryColumn.TIMEUSED))));
			viewHolder.takeplaceTime.setText(getString(R.string.takeplace_time_tip) +
					Utils.formatTs(mCtx, c.getLong(c.getColumnIndex(BoottimeHistoryColumn.TS))));
			return convertView;
		}		
	}
