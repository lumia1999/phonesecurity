...
public class ImageResizer extends ImageWorker {
	 ...
	 * @return
	 */
	private BitmapItem processBitmap(int resId) {
		if (BuildConfig.DEBUG) {
			Log.d(TAG, "processBitmap - " + resId);
		}
		return new BitmapItem(decodeSampledBitmapFromResource(mResources,
				resId, mImageWidth, mImageHeight, getImageCache()),
	...
	public static Bitmap decodeSampledBitmapFromDescriptor(
		...
		if (Utils.hasHoneycomb() && cache != null) {
			if (BuildConfig.DEBUG) {
				Log.d(TAG, "try addInBitmapOptions");
			}
			addInBitmapOptions(options, cache);
		}
